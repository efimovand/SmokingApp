            ...
            ScrollView([.horizontal, .vertical] , showsIndicators: false) {
                ...
                ZStack{
                    ...
                    Group{
                        ...
                        mapPoint(text: "Повседневные физические нагрузки проходят легче", picture: Image("walking"), description: "Это происходит благодаря улучшению кровообращения и оксигенации, так как функционирование легких улучшается примерно на 30 процентов - университет Мичигана", number: 14).offset(x: 370, y: 150)
